$(document).ready(function () {
	...
	$('#open-pop-up-9').click(function (e) {
        e.preventDefault();
        $('#pop-up-9').popUpWindow({
            action: "open",
            size: "small"
        });
    });
	
	$('#open-pop-up-10').click(function (e) {
        e.preventDefault();
        $('#pop-up-10').popUpWindow({
            action: "open",
            size: "small"
        });
    });
	
	$('#open-pop-up-11').click(function (e) {
        e.preventDefault();
        $('#pop-up-11').popUpWindow({
            action: "open",
            size: "small"
        });
    });
	
	$('#open-pop-up-12').click(function (e) {
        e.preventDefault();
        $('#pop-up-12').popUpWindow({
            action: "open",
            size: "small"
        });
    });
	
	$('#open-pop-up-13').click(function (e) {
        e.preventDefault();
        $('#pop-up-13').popUpWindow({
            action: "open",
            size: "small"
        });
    });
